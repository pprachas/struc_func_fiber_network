...
for ii,max_res in enumerate(max_res_all):
    # Name of mesh
    mesh_name=f'../sensitivity/mesh/n500/voronoi1.xdmf'
    ...
    plt.plot(disp_x,disp_y, markersize = 0.75, marker = ',', ls = 'none', c = colors[ii])
...
plt.savefig(f'sensitivity/deformed_network/compare_sensitivity.pdf')
