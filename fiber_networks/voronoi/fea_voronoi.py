...
f_name = f'fea_run/n{n}/kappa_tilde{kappa_tilde}/seed{seed}'
...
fea.run_fea(mesh_name, f_name, r, L, step_size, ['r','r'], crit_strains[seed][num_kappa_tilde]*1.5, compute_individual = True, abs_tol = 1e-10, rel_tol = 1e-12, init_c0 = 1e-7, max_damping_res = max_damping) # make runs stop after strain stiffening