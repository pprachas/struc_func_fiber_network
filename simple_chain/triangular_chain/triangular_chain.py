...
run = int(sys.argv[2])
lmbda =  (L/np.array([5,10,20,40]))[run]#(L/np.array([1,5,10,20,40]))[run]

num_segments = np.loadtxt('mesh_refinement/final_char.txt', dtype=int)
...
sc.create_triangular_simple_chain(amplitude, lmbda, L, num_segments)
